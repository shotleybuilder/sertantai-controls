...
#
#     PHX_SERVER=true bin/sertantai_controls start
#
...
if config_env() == :prod do
  ...
  database_url =
    System.get_env("SERTANTAI_DATABASE_URL") || System.get_env("DATABASE_URL") ||
      raise """
      environment variable SERTANTAI_DATABASE_URL or DATABASE_URL is missing.
  ...
  config :sertantai_controls, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
